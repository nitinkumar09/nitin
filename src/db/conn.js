...
const dbName = 'hostdb';            // yahi database use karna hoga mongosh shell par 
const mongoURI = `mongodb+srv://kumarmongo8865:%40mongo8865@cluster0.we1bjmz.mongodb.net/${dbName}`;
async function main() {
